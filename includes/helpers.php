<?php
/**
 * This file adds helper functions used in the WPSnappy Theme.
 *
 * @package   WPSnappy
 ...
 */
function wpsnappy_minify_css( $css ) {
 ...
 * @return bool
 */
function wpsnappy_is_woocommerce_page() {
 ...
 * @return string
 */
function wpsnappy_custom_header() {
